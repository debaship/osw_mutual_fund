...
if (window.location.hash) {
  if (location.hash.substring(1) === "eng") {
    ...
    instructionalVideo = language.ru.instructionalVideo;
    blankDescription = language.ru.blankDescription;
    noFileAPI = language.ru.noFileAPI;
    errorReading = language.ru.errorReading;
    dvalueisblank = language.ru.dvalueisblank;
    unableToExportFields = language.ru.unableToExportFields;
    urlExportError = language.ru.urlExportError;
    dyes = language.ru.dyes;
    dno = language.es.dno;
